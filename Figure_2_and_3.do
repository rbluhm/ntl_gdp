...
graph combine gdp_coefs_USA.gph gdp_coefs_Germany.gph gdp_coefs_Italy.gph ///
	gdp_coefs_Spain.gph gdp_coefs_Brazil.gph gdp_coefs_China.gph, ///
	xcommon 
graph export figure_2_betas.pdf, replace 
...
graph combine gdp_thetas_USA.gph gdp_thetas_Germany.gph gdp_thetas_Italy.gph ///
	...
	xcommon
graph export figure_3_thetas.pdf, replace 
